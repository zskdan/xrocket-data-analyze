...
path = '/home/zakaria/workspace/fusex/visu-3d/donnees_vol.txt.euler'
ser = open(path,'r')

# Main scene
scene = canvas(title="Pololu MinIMU-9 + Arduino AHRS")
...
scene2 = canvas(title='Pololu MinIMU-9 + Arduino AHRS',x=0, y=0, width=500, height=200,center=vector(0,0,0), background=vector(0,0,0))
scene2.range=1,1,1
